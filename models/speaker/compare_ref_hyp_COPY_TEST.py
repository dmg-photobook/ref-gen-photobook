...
if __name__ == '__main__':
    ...
    model_file = 'all_copy_TEST'

    with open('../FINAL_SPEAKERS/TEST_JSONS/copy/hyps_copy_bert_test_2020-05-26-21-40-53.json', 'r') as f:
        hyps42 = json.load(f)

    with open('../FINAL_SPEAKERS/TEST_JSONS/copy/hyps_copy_bert_test_2020-05-26-21-45-54.json', 'r') as f:
        hyps1 = json.load(f)

    with open('../FINAL_SPEAKERS/TEST_JSONS/copy/hyps_copy_bert_test_2020-05-26-21-51-50.json', 'r') as f:
        hyps2 = json.load(f)

    with open('../FINAL_SPEAKERS/TEST_JSONS/copy/hyps_copy_bert_test_2020-05-26-21-56-38.json', 'r') as f:
        hyps3 = json.load(f)

    with open('../FINAL_SPEAKERS/TEST_JSONS/copy/hyps_copy_bert_test_2020-05-26-22-1-31.json', 'r') as f:
        hyps4 = json.load(f)

    with open('../FINAL_SPEAKERS/TEST_JSONS/copy/refs_copy_bert_test_2020-05-26-21-40-53.json', 'r') as f:
        refs = json.load(f)
