...
if __name__ == '__main__':
    ...
    for i, data in enumerate(test_loader):
        ...
        if actual_prev_string == '<nohs>':
            ...
            ongoing_hyp42 = hyps42[i]
            ongoing_hyp1 = hyps1[i]
            ongoing_hyp2 = hyps2[i]
            ongoing_hyp3 = hyps3[i]
            ongoing_hyp4 = hyps4[i]

        else:
            hyps42_later.append(ongoing_hyp42)
            hyps1_later.append(ongoing_hyp1)
            hyps2_later.append(ongoing_hyp2)
            hyps3_later.append(ongoing_hyp3)
            hyps4_later.append(ongoing_hyp4)

            refs_later.append(refs[i])

    output_dicts = {'42': (hyps42_first, hyps42_later),
                    '1': (hyps1_first, hyps1_later),
                    '2': (hyps2_first, hyps2_later),
                    '3': (hyps3_first, hyps3_later),
                    '4': (hyps4_first, hyps4_later)}
