...
vocab_csv_path = '../data/vocab_COPY.csv'
...
def process_data(data, split):
    ...
    chains_path = '../data/' + split + '_COPY_text_chains.json'
    utterances_path = '../data/' + split + '_COPY_text_utterances.pickle'
...
with open('../data/train_COPY_text_utterances.pickle', 'rb') as f:
    train_utterances = pickle.load(f)

with open('../data/val_COPY_text_utterances.pickle', 'rb') as f:
    val_utterances = pickle.load(f)

with open('../data/test_COPY_text_utterances.pickle', 'rb') as f:
    test_utterances = pickle.load(f)

vocab = Vocab('../data/vocab_COPY.csv')
...
def convert2indices(dataset, vocab, split):
    ...
    new_file_name = '../data/' + split + '_COPY_ids_utterances.pickle'
