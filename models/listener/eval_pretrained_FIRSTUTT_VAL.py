...
def evaluate_trained_model(split_data_loader, split_dataset, model, device):
    ...
    for ii, data in enumerate(split_data_loader):
        ...
        # if the target image has NO history
        if len(prev_hist[0][targets]) == 0:

            # ONLY IF THE TARGET IMAGE HAS NO HISTORY! MEANING THEY ARE THE FIRST UTTERANCES
...
if __name__ == '__main__':
    ...
    model_files = ['saved_models/model_listener_NEW_bert_att_ctx_base_CE_42_accs_2020-05-29-21-15-8.pkl',
'saved_models/model_listener_NEW_bert_att_ctx_base_CE_1_accs_2020-05-29-21-13-23.pkl',
'saved_models/model_listener_NEW_bert_att_ctx_base_CE_2_accs_2020-05-29-21-14-8.pkl',
'saved_models/model_listener_NEW_bert_att_ctx_base_CE_3_accs_2020-05-19-20-36-46.pkl',
'saved_models/model_listener_NEW_bert_att_ctx_base_CE_4_accs_2020-05-29-21-16-8.pkl',
'saved_models/model_listener_NEW_bert_att_ctx_hist_base_CE_42_accs_2020-05-16-14-18-44.pkl',
