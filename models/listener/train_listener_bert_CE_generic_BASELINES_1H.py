...
from models.model_bert_BASELINE_1H import ListenerModelBertBaseline1H
...
from utils.ListenerDatasetBert_baseline1H import ListenerDataset_1H
...
if __name__ == '__main__':
    ...
    parser.add_argument("-model_type", type=str, default='baseline_1H')
    ...
    if model_type == 'baseline_1H':  #
        model = ListenerModelBertBaseline1H(embedding_dim, hidden_dim, img_dim, att_dim, dropout_prob).to(device)
    ...
    load_params = {'batch_size':batch_size, 'shuffle': shuffle,
                   'collate_fn': ListenerDataset_1H.get_collate_fn(device)}
