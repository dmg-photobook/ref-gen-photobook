...
class ListenerModelBertAttCtx(nn.Module):
    ...
    def init_weights(self):
        ...
        for ll in [self.linear_separate, self.lin_emb2hid, self.lin_context, self.lin_mm,
    ...
    def forward(self, representations, lengths, separate_images, visual_context, prev_hist, masks, device):
        ...
        # no linguistic history as this is the ablation
        # just use visual representations of the candidates
